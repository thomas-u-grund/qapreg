...
<!-- GitHub Actions badge will appear here -->
...
Users familiar with `sna::netlogit()` can fit models directly from
adjacency matrices.
...
The `summary()` method reports both conventional and QAP-based inference
statistics.
